function [ax3,p3] = plotWhiskerAngle_sleepScoringSlider(procDataFileID)
...
p3 = plot((1:length(filteredWhiskerAngle))/ProcData.notes.dsFs,-filteredWhiskerAngle,'color',[0.8 0.1 0.4],'LineWidth',1);
ylabel('Angle (deg)')
